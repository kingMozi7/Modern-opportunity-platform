...
if (isset($_POST['submit'])) {
    ...
    if ($_FILES["img"]["error"] === 4) {
        ...
        if (!in_array($imageExtension, $validImageExtension)) {
           ...
           $query = "INSERT INTO seek_prof (pic, name, bio, education, skills) VALUES ('$newImageName', '$name', '$bio', '$education', '$skills')";
            if (mysqli_query($db, $query)) {
                echo  "<script>alert('Successfully uploaded your data'); window.location.href='jobSeeker.php';</script>";
            } else {
                    ...
                    <div
                        ...
                        <form method="post" autocomplete="off" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="education" class="form-control" style="height:100px"></textarea>
                            </div>
                            <div class="form-group">
                                <label>Skills</label>
                                <textarea name="skills" class="form-control" style="height:100px"></textarea>
                            </div>
...
<div class="container bg-info " style="height:500px">
	...
	<div class="row" style="height:100%">
		...
		<div class="col-md-3">
	<div style="width: 100px; height: 100px; background-color: rgba(255,255 ,255 , 0.5) ; border-radius: 50%; margin-top: 10px; margin-left: 85px;  color:white">
	<img src="img/MainAfter.jpg" alt="profile image" style="width:100% ;height: 100%; border-radius: 50%;">
	</div>
	<div>
...
<div>
	...
	<div style="background-color: rgba(255,255 ,255 , 0.5); height:5cm ; width:100%; margin-top:5px; ">
		<p style="text-align:center; font-weight: bold;"><span>Bio</span></p>
	</div>
	</div>
	<div class="col-md-9">
		<div style="background-color: rgba(255,255 ,255 , 0.5); height:11.1cm ; margin-top: 10px;">
		<form>
			<div style="border:1px solid rgba(0, 51, 200, 0.2); height: 200px; border-radius:5px;">
				<p ><span style="border-bottom: 2px solid black; margin:5px;font-size:24px ; font-weight:bold;">Education</span></p>
				<p>  </p>
			</div>
			<div style="border:1px solid rgba(0, 51, 200, 0.2); height: 200px; border-radius:5px; margin-top: 20px;">
				<p ><span style="border-bottom: 2px solid black; margin:5px;font-size:24px ; font-weight:bold;">Skills</span></p>
			<p> </p>
			</div>
			</form>
		</div>
